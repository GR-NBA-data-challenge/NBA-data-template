...
# historical_data: the full data of all previous years. This data item does not change over time.
# current_season_matches: the full data of all previous games already played in the current season.
